...
import { Menu, Search, ShoppingCart, MapPin, ChevronDown, User } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex-shrink-0 cursor-pointer" onClick={() => navigate("/")}>
            <h1 className="text-3xl font-bold text-primary-foreground tracking-wider">KFC</h1>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="hidden xl:inline max-w-32 truncate">{location}</span>

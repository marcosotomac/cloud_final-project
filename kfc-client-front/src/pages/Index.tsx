        ...
        <section className="bg-primary py-8 sm:py-12">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-center gap-4 sm:gap-8 text-white text-center">
              <div>
                <h2 className="text-xl sm:text-3xl font-bold mb-1 sm:mb-2">¡Descarga el APP!</h2>
                <p className="text-white/80 text-sm sm:text-base">Promociones exclusivas solo en nuestra app</p>
              </div>
